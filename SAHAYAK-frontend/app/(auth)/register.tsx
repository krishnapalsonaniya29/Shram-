...
export default function RegistrationPage() {
  ...
  try {
    console.log("Worker request payload:", data);
    ...
    console.log("Worker registration error:", error?.response?.data);
  ...
  const renderLandingSelection = () => (
    <View style={register.landingContainer}>
      ...
      <TouchableOpacity
        style={register.roleCard}
        // onPress={() => setSelectedRole("Worker")}
       // onPress={() => router.push("/(auth)/mpDomicile")}
       onPress={() =>
  router.push({
    pathname: "/(auth)/mpDomicile",
    params: { from: "Worker" },
  })
}
...
//   //       console.log("Worker register response:", response.success);
